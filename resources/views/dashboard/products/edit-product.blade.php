    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <h4 class="h4 mb-0 text-gray-800">Edit Product</h4>
            </div>
        </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('product.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf <!-- for website authentication -->
                                @method('PUT')
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{$product->name}}" id="productName" placeholder="Enter product name" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="description"  id="productDescription" rows="3" placeholder="Enter product description">{{$product->description}}</textarea>
                                        </div>

                                        <div class="mb-3 form-check">
                                            <input type="checkbox" class="form-check-input" name="is_featured" id="featuredProduct"  {{$product->is_featured == 1 ? 'checked' : ''}}>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="price" value="{{$product->price}}" id="productPrice" placeholder="0.00" step="0.01" min="0" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="productSalePrice" class="form-label">Sale Price ($) (Optional)</label>
                                                <input type="number" class="form-control"  name="sale_price" value="{{$product->sale_price}}" id="productSalePrice" placeholder="0.00" step="0.01" min="0">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control"  name="qty" value="{{$product->qty}}" id="productQuantity" placeholder="0" min="0" required>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="text-left p-3 border rounded" >
                                                    <img  src="{{asset($product->featured_image)}}" class="img-fluid" style=" height: 200px; width:200px;" alt="Old Image">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="text-left p-3 border rounded" id="imagePreviewContainer">
                                                    <img  id="imagePreview" class="img-fluid d-none" style=" height:200px; width:200px;" alt="Product Preview">
                                                    <p class="text-muted mb-0" id="noImageText">No image selected</p>
                                                </div>
                                            </div>
                                        </div>
